...
public enum ResponseStatus {
    ...
    SUCCESS_UPDATE_PROFILE(200, 204, "프로필 수정에 성공하였습니다."), SUCCESS_SELECT_USERAREA(200, 204, "유저 거래지역 조회에 성공하였습니다."),
    SUCCESS(200, 200, "요청에 성공하였습니다."), SUCCESS_SIGN_IN(200, 201, "로그인에 성공하였습니다."),
    SUCCESS_SELECT_AREA(200, 204, "지역 조회에 성공하였습니다."), SUCCESS_GET_FOLLOW_LIST(200, 202, "팔로우 리스트를 가져오는데 성공하였습니다."),
    SUCCESS_SELECT_DEAL_LIST(200, 205, "거래 조회에 성공하였습니다."), SUCCESS_SELECT_DEAL_DETAIL(200, 208, "거래 상세 조회에 성공하였습니다."),
    SUCCESS_SELECT_PROFILE(200, 203, "프로필 조회에 성공하였습니다."), SUCCESS_SELECT_BOOK(200, 210, "책 정보 조회에 성공하였습니다."),
